...
class activity_completed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' completed the activity with id '$this->objectid' for the cmi5 with " .
    ...
    public static function get_name() {
        return get_string('eventactivitycompleted', 'mod_cmi5launch');
    }
