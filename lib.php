 ...
 * @param bool $nullifnone - If a single user is specified, $nullifnone is true and the user has no grade then a grade item with a null rawgrade should be inserted.
 */
