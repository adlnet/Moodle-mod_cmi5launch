...
class ContextActivitiesTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        ...
        $this->assertInstanceOf('cmi5\ContextActivities', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\ContextActivities'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\ContextActivities'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\ContextActivities'));
    }
    ...
    public function testCompareWithSignature() {
        ...
        $this->runSignatureCases("cmi5\ContextActivities", $cases);
    }
