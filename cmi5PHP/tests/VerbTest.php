...
class VerbTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $obj = new Verb();
        $this->assertInstanceOf('cmi5\Verb', $obj);
        $this->assertAttributeEmpty('id', $obj, 'id empty');
        $this->assertAttributeInstanceOf('cmi5\LanguageMap', 'display', $obj, 'display is LanguageMap');
    }
    ...
    public function testCompareWithSignature() {
        ...
        $this->runSignatureCases("cmi5\Verb", $cases);
    }
}
