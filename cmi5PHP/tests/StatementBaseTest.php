...
use cmi5\StatementBase;
use cmi5\SubStatement;
use cmi5\Verb;
use cmi5\Agent;
use cmi5\Context;
use cmi5\Result;
...
class StatementBaseTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testSetTargetAsSAgent() {
        ...
        $obj->setTarget($ss);
        $this->assertInstanceOf('cmi5\Agent', $obj->getTarget());
    }
    ...
    public function testSetTargetAsGroup() {
        ...
        $obj->setTarget($ss);
        $this->assertInstanceOf('cmi5\Group', $obj->getTarget());
    }
    ...
    public function testSetTargetAsSubStatement() {
        ...
        $obj->setTarget($ss);
        $this->assertInstanceOf('cmi5\SubStatement', $obj->getTarget());
    }
    ...
    public function testSetActorAsGroup() {
        ...
        $obj->setActor($ss);
        $this->assertInstanceOf('cmi5\Group', $obj->getActor());
    }
