...
class ResultTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $obj = new Result();
        $this->assertInstanceOf('cmi5\Result', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\Result'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\Result'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\Result'));
    }
    ...
    public function testCompareWithSignature() {
        ...
        $this->runSignatureCases("cmi5\Result", $cases);
    }
}
