...
class AboutTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $obj = new About();
        $this->assertInstanceOf('cmi5\About', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\About'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\About'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\About'));
    }
    ...
    public function testExtensionsWithArray() {
        ...
        $this->assertInstanceOf('cmi5\Extensions', $obj->getExtensions());
