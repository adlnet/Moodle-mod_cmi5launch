...
class ExtensionsTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $obj = new Extensions();
        $this->assertInstanceOf('cmi5\Extensions', $obj);
    }
    ...
    public function testCompareWithSignature() {
        ...
        $cases = [
            ...
            [
                ...
                'objArgs'     => $extensions1,
                'sigArgs'     => [],
                'reason'      => 'http://id.cmi5api.com/extension/topic not in signature'
            ],
            [
                'description' => 'empty this: mismatch',
                'objArgs'     => [],
                'sigArgs'     => $extensions1,
                'reason'      => 'http://id.cmi5api.com/extension/topic not in this'
            ],
            [
            ...
            [
                ...
                'reason'      => 'http://id.cmi5api.com/extension/topic does not match'
            ],
            [
        ...
        $this->runSignatureCases("cmi5\Extensions", $cases);
    }
}
