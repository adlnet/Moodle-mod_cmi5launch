...
class ContextTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $obj = new Context();
        $this->assertInstanceOf('cmi5\Context', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\Context'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\Context'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\Context'));
    }
    ...
    */
    ...
    public function testCompareWithSignature() {
        ...
        $cases = [
            ...
            [
                ...
                'reason'      => 'Comparison of extensions failed: http://id.cmi5api.com/extension/location not in signature'
            ],
            [
        ...
        $this->runSignatureCases("cmi5\Context", $cases);
    }
    ...
    public function testSetInstructorConvertToGroup() {
        ...
        $this->assertInstanceOf('cmi5\Group', $obj->getInstructor());
    }
