...
class ActivityDefinitionTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        ...
        $this->assertInstanceOf('cmi5\ActivityDefinition', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\ActivityDefinition'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\ActivityDefinition'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\ActivityDefinition'));
    }
