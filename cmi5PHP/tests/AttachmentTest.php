...
class AttachmentTest extends \PHPUnit_Framework_TestCase {
    ...
    const USAGE_TYPE     = 'http://id.cmi5api.com/attachment/supporting_media';
    const DISPLAY        = 'testDisplay';
    const DESCRIPTION    = 'Test description.';
    const FILE_URL       = 'http://cmi5api.com/cmi5php/attachment/fileUrl';
    ...
    public function testInstantiation() {
        $obj = new Attachment();
        $this->assertInstanceOf('cmi5\Attachment', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\Attachment'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\Attachment'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\Attachment'));
    }
    ...
    public function testCompareWithSignature() {
        ...
        $this->runSignatureCases("cmi5\Attachment", $cases);
    }
}
