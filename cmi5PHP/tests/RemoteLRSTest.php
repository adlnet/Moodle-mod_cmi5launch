...
class RemoteLRSTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $lrs = new RemoteLRS();
        $this->assertInstanceOf('cmi5\RemoteLRS', $lrs);
    ...
    public function testSaveStatements() {
        ...
        foreach ($response->content as $i => $st) {
            $this->assertInstanceof('cmi5\Statement', $st, "$i: is statement");
            $id = $st->getId();
    ...
    public function testSaveStatementsWithAttachments() {
        $lrs = new RemoteLRS(self::$endpoint, self::$version, self::$username, self::$password);
        $attachment1 = [
            'usageType'   => 'http://id.cmi5api.com/attachment/supporting_media',
    ...
    public function testRetrieveVoidedStatement() {
        ...
        $this->assertInstanceOf('cmi5\LRSResponse', $retrieveResponse);
        $this->assertTrue($retrieveResponse->success);
        $this->assertInstanceOf('cmi5\Statement', $retrieveResponse->content);
    }
    ...
    public function testQueryStatements() {
        ...
        $this->assertInstanceOf('cmi5\LRSResponse', $response);
        $this->assertTrue($response->success, 'success');
        $this->assertInstanceOf('cmi5\StatementsResult', $response->content);
    }
    ...
    public function testMoreStatements() {
        ...
        $this->assertInstanceOf('cmi5\LRSResponse', $response);
        $this->assertTrue($response->success, 'success');
        $this->assertInstanceOf('cmi5\StatementsResult', $response->content, 'content');
    }
