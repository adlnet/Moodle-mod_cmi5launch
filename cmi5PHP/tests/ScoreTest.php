...
class ScoreTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testInstantiation() {
        $obj = new Score();
        $this->assertInstanceOf('cmi5\Score', $obj);
    ...
    public function testUsesArraySetterTrait() {
        $this->assertContains('cmi5\ArraySetterTrait', class_uses('cmi5\Score'));
    }

    public function testUsesFromJSONTrait() {
        $this->assertContains('cmi5\FromJSONTrait', class_uses('cmi5\Score'));
    }

    public function testUsesAsVersionTrait() {
        $this->assertContains('cmi5\AsVersionTrait', class_uses('cmi5\Score'));
    }
    ...
    public function testCompareWithSignature() {
        ...
        $this->runSignatureCases("cmi5\Score", $cases);
    }
}
