...
class ActivityTest extends \PHPUnit_Framework_TestCase {
    ...
    static public function setUpBeforeClass() {
        self::$DEFINITION = [
            'type' => 'http://id.cmi5api.com/activitytype/unit-test',
            'name' => [
                'en-US' => 'test',
                'en-GB' => 'test',
                'es'    => 'prueba'
    ...
    public function testInstantiation() {
        $obj = new Activity();
        $this->assertInstanceOf('cmi5\Activity', $obj);
    ...
    public function testFromJSONInvalidNull() {
        $this->setExpectedException('cmi5\JSONParseErrorException');
    ...
    public function testCompareWithSignature() {
        ...
        $definition2 = array_replace(self::$DEFINITION, ['type' => 'http://id.cmi5api.com/activitytype/unit-test-suite']);
        $cases = [
            [
        ...
        $this->runSignatureCases("cmi5\Activity", $cases);
    }
}
