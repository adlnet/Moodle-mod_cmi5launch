...
//This is a good way, scorm has columns and rows too!

class report extends \mod_scorm\report {
    /**
     * displays the full report
     * @param \stdClass $cmi5launch full SCORM (cmi5) object
     * @param \stdClass $cm - full course_module object
     * @param \stdClass $course - full course object
     * @param string $download - type of download being requested
     */

     //Ok, this display is what is called on line 134 in the report.php
    public function display($cmi5launch, $cm, $course, $download) {
